 ...
 * 
 */
@WebServiceClient(name = "Servicios", targetNamespace = "http://Modelo/", wsdlLocation = "http://localhost:8080/SerBiblioteca/Servicios?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOS_QNAME = new QName("http://Modelo/", "Servicios");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SerBiblioteca/Servicios?wsdl");
    ...
    public Servicios getServiciosPort() {
        return super.getPort(new QName("http://Modelo/", "ServiciosPort"), Servicios.class);
    }
    ...
    public Servicios getServiciosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Modelo/", "ServiciosPort"), Servicios.class, features);
    }
