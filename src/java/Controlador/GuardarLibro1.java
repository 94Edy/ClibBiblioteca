 ...
 * @author USUARIO
 */
public class GuardarLibro1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GuardarLibro1</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GuardarLibro1 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        int nroPaginasM, nroEjemplaresM, res;
        ...
        accion = request.getParameter("accion");   //creando variable accion
        if (accion.equalsIgnoreCase("Guardar")) {   

            codigoM = request.getParameter("codigoM");  //encapsulando informacion de los inputs... asignado en variables para guardar en base de datos
            ...
            //uso del webServis
            msj = guardarLibro(codigoM, autorM, edicionM, anioPublicacionM, tituloM, ciudadM, paisM, editorialM, registroISBNM, nroPaginasM, estadoM, nroEjemplaresM, incluyeCd, tipoM, tiempoVigenciaM);
